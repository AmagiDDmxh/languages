...
exercise1 :: IO ()
exercise1 = activityOf (C 0 1) handleEvent drawState
...
exercise2 :: IO ()
exercise2 = activityOf initialState handleEvent2 drawState2
...
resetableActivityOf ::
    ...
    IO ()
resetableActivityOf state0 step handle draw
